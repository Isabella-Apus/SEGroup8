...
- `identity-governance-service`：15 tests，15 passed，0 failed/errors/skipped
...
逐接口映射见 `02_docs/microservices/identity-governance-service/service-api-list.md`。原始 XML/TXT 由 Surefire 直接写入 `evidence/raw-reports/surefire/`。
