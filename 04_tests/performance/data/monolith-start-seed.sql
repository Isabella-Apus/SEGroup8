...
WHERE (`product_type` = 'NEW' AND `product_id` = 980001)
   OR (`product_type` = 'SECONDHAND' AND `product_id` BETWEEN 990001 AND 990040);
...
DELETE FROM `auction_log` WHERE `auction_id` BETWEEN 999001 AND 999002;
DELETE FROM `product_auction` WHERE `id` BETWEEN 999001 AND 999002;
DELETE FROM `secondhand_product` WHERE `id` BETWEEN 990001 AND 990042;
...
DELETE FROM `transaction_record` WHERE `user_id` IN (950001, 950002, 950003);
DELETE FROM `balance` WHERE `user_id` IN (950001, 950002, 950003);
DELETE FROM `user` WHERE `id` IN (950001, 950002, 950003);
...
VALUES
  ...
  (990041,950001,'Performance Auction Item 1','','[]','Reserved k6 auction item',500.00,300.00,8,801,'95%',0,1),
  (990042,950001,'Performance Auction Item 2','','[]','Reserved k6 auction item',500.00,300.00,8,801,'95%',0,1);
