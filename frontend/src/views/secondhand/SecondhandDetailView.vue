  ...
  <div class="page-card">
    ...
    <div v-else-if="item" class="detail-wrap">
      ...
      <div class="info-box">
        ...
        <el-space wrap>
          <el-button type="primary" :loading="buySubmitting" @click="handleBuyNow" :disabled="!canBuyOnePrice">立即购买</el-button>
    ...
    <el-dialog v-model="auctionCreateDialogVisible" title="发起拍卖" width="460px">
      <el-form label-width="110px">
        ...
        <el-form-item label="起拍价" required>
          <el-input-number
            v-model="auctionCreateForm.startPrice"
            :min="0.01"
            :precision="2"
            :step="1"
            style="width: 100%"
        ...
        <el-form-item label="加价幅度" required>
          <el-input-number
            v-model="auctionCreateForm.incrementAmount"
            :min="0.01"
            :precision="2"
            :step="1"
            style="width: 100%"
        ...
        <el-form-item label="拍卖时长(分钟)" required>
          <el-input-number
            v-model="auctionCreateForm.durationMinutes"
            :min="10"
            :max="1440"
            :step="10"
            style="width: 100%"
...
async function confirmBuyWithAddress() {
  ...
  try {
    ...
    ElMessage.success("下单成功，请前往我的订单-待付款完成支付");
    router.push("/order");
  } catch (e) {
