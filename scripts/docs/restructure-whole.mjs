...
测试计划、测试报告和追溯表统一位于 \`../02_docs/UCxx/\`。重构前的聚合测试计划、人工走查和阶段性报告保存在 \`../05_management/archive/test-assets/\`。

CI 临时摘要写入 \`.ci/\` 并作为 GitHub Actions Artifact 上传，不在 \`04_tests/\` 中长期保存。
`);
