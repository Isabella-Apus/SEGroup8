...
INSERT INTO user (id, username, role, status, create_time, update_time) VALUES
  (1201, 'uc12_buyer', 'USER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1202, 'uc12_other', 'USER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1203, 'uc12_seller', 'OFFICIAL_SELLER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES (1201, 1201, 'UC12 Product', 100.00, 20, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
