...
DELETE FROM product WHERE id IN (1501, 1502, 1503);
DELETE FROM shop WHERE id IN (1501, 1502);
DELETE FROM user WHERE id IN (1501, 1502, 1503, 1504);

INSERT INTO user (id, username, password, nickname, role, status, create_time, update_time)
VALUES
  (1501, 'uc15buyer', 'x', 'UC15 Buyer', 'USER', 'NORMAL', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1502, 'uc15seller', 'x', 'UC15 Seller', 'OFFICIAL_SELLER', 'NORMAL', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1503, 'uc15otherseller', 'x', 'UC15 Other Seller', 'OFFICIAL_SELLER', 'NORMAL', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1504, 'uc15otherbuyer', 'x', 'UC15 Other Buyer', 'USER', 'NORMAL', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO shop (id, owner_user_id, name, status, create_time, update_time)
VALUES
  (1501, 1502, 'UC15 Review Shop', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1502, 1503, 'UC15 Other Review Shop', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
  ...
  (1503, 1502, 'UC15 Other Seller Product', 50.00, 20, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
