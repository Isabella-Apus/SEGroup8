...
INSERT INTO product_auction
  ...
  (19301, 19101, 1901, 100.00, 10.00, 100.00, NULL, DATE_SUB(NOW(), INTERVAL 10 MINUTE), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'ONGOING', NULL, 0, NOW(), NOW()),
  (19302, 19102, 1901, 100.00, 10.00, 100.00, NULL, DATE_SUB(NOW(), INTERVAL 10 MINUTE), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'ONGOING', NULL, 0, NOW(), NOW()),
  (19303, 19103, 1901, 100.00, 10.00, 100.00, NULL, DATE_SUB(NOW(), INTERVAL 10 MINUTE), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'ONGOING', NULL, 0, NOW(), NOW()),
  (19304, 19104, 1901, 100.00, 10.00, 100.00, NULL, DATE_SUB(NOW(), INTERVAL 10 MINUTE), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'ONGOING', NULL, 0, NOW(), NOW()),
  (19305, 19105, 1901, 100.00, 10.00, 100.00, NULL, DATE_SUB(NOW(), INTERVAL 10 MINUTE), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'ONGOING', NULL, 0, NOW(), NOW()),
  (19306, 19106, 1901, 100.00, 10.00, 100.00, NULL, DATE_ADD(NOW(), INTERVAL 10 MINUTE), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'ONGOING', NULL, 0, NOW(), NOW()),
  (19307, 19107, 1901, 100.00, 10.00, 100.00, NULL, DATE_SUB(NOW(), INTERVAL 1 HOUR), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'FLOW', NULL, 1, NOW(), NOW()),
  (19308, 19108, 1901, 100.00, 10.00, 100.00, NULL, DATE_SUB(NOW(), INTERVAL 10 MINUTE), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'ONGOING', NULL, 0, NOW(), NOW()),
  (19309, 19109, 1901, 100.00, 10.00, 100.00, NULL, DATE_SUB(NOW(), INTERVAL 1 HOUR), DATE_SUB(NOW(), INTERVAL 1 MINUTE), 'ONGOING', NULL, 0, NOW(), NOW()),
  (19310, 19110, 1901, 80.00, 5.00, 80.00, NULL, DATE_SUB(NOW(), INTERVAL 2 HOUR), DATE_SUB(NOW(), INTERVAL 1 HOUR), 'FLOW', NULL, 1, NOW(), NOW());
