...
public record TradeOrderRequest(long id, String tradeType, String tradeId, String orderBusinessKey,
        ...
        String productName, String receiverName, String receiverPhone, String receiverProvince,
        String receiverCity, String receiverDetailAddress, String remark,
        String requestStatus, Long orderId, String orderNo, String orderStatus,
